...
import type { Image, OrderItemRow, ProductWithDetails } from "@/shared/types";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { BudgetItemFormSchema, OrderItemFormSchema } from "@/shared/schemas";
          ...
          <Form {...form}>
            ...
            >
              <ProductsCombobox
                ...
                className="w-full"
                onChange={(product) =>
                  handleProductChange(product as ProductWithDetails)
                }
              />
